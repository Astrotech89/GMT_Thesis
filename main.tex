...
\thesistitle{Opto-Mechanical Design for a Single Laser Adaptive Optics System for METIS} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
\supervisor{Dr. Remko Stuik \& \\ Prof. Bernhard Brandl} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname

\examiner{Prof. Bernhard Brandl} % Your examiner's name, this is not currently used anywhere in the template, print it elsewhere with \examname
\degree{Masters Thesis 1} % Your degree name, this is used in the title page and abstract, print it elsewhere with \degreename
...
\university{\href{http://www.university.com}{Leiden University}} % Your university's name and URL, this is used in the title page and abstract, print it elsewhere with \univname
...
\group{METIS Group} % Your research group's name and URL, this is used in the title page, print it elsewhere with \groupname
\faculty{\href{http://faculty.university.com}{Astronomy Department}} % Your faculty's name and URL, this is used in the title page and abstract, print it elsewhere with \facname
...
\textbf{ELT} & Extremely Large Telescope\\
\textbf{PSF} & Point Spread Function\\
\textbf{METIS} & Mid-infrared ELT Imager and Spectrograph\\
\textbf{DM} & Deformable Mirror \\
\textbf{AO} & Adaptive Optics \\
\textbf{SCAO} & Single Conjugate Adaptive Optics\\
\textbf{SLAO} & Single Laser Adaptive Optics \\ 
\textbf{LTAO} & Laser Tomography Adaptive Optics \\
\textbf{GLAO} & Ground Layer Adaptive Optics \\ 
\textbf{MCAO} & Multi-Conjugate Adaptive Optics \\
\textbf{MOAO} & Multi-Object Adaptive Optics \\
\textbf{NGS} & Natural Guide Star\\
\textbf{LGS} & Laser Guide Star \\
\textbf{WFS} & WaveFront Sensor \\
\textbf{PWS} & Pyramid Wavefront Sensor \\ 
\textbf{SHWFS} & Shack-Hartmann Wavefront Sensor\\
\textbf{MICADO} & Multi-AO Imaging Camera for Deep Observations\\
\textbf{HARMONI} & High Angular Resolution Monolithic Optical and Near infrared\\  & Integral field spectrograph\\
\textbf{PFS} & Pre-Focal Station\\
\textbf{MLA} & Micro-lens Array\\
